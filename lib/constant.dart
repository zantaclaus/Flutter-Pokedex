...
const colors = {
  ...
  "Electric": Color(0xffFFDF63),
  "Fairy": Color(0xffFFC0F9),
  ...
  "Dark": Color(0xff5E5E5E),
  "Psychic": Color(0xffFF94F4),
  "Steel": Color(0xff696666),
...
const backgrounds = {
  ...
  "Electric": Color(0xffFBC73F),
  "Fairy": Color(0xffF27CFC),
  ...
  "Steel": Color(0xff424141),
  "Flying": Color(0xff3CAAFB),
  "Ice": Color(0xff27DACF),
};
